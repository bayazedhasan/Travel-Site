...
const PopularHotels = () => {
    ...
    return (
        <div className='mt-20 container mx-auto px-6 lg:px-12'>
        ...
        hotels.slice(0, 3).map(h => (
            <div key={h.name}>
                <div className='border border-gray-300 rounded-xl flex flex-col shadow-lg shadow-amber-200 cursor-pointer 
                    h-[350px] sm:h-100 w-85 sm:w-115 hover:scale-105 duration-300'>

                    <div>
                        <img className='w-85 sm:w-115 h-[200px] sm:h-60 object-cover rounded-t-xl' src={h.img} alt={h.name} />
                    </div>
